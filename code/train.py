...
def train(epoch):
    ...
    stats['in_struc'] = model_stat_struc(in_layers_pred, adjs, layer_metrics, adjs_pos_weights, adjs_norms)
    stats['bet_struc'] = model_stat_struc(bet_layers_pred, bet_adjs, layer_metrics, bet_pos_weights, bet_norms)
    # Write to writer
...
if __name__=='__main__':
    ...
    # Load data
    adjs, adjs_sizes, adjs_pos_weights, adjs_norms, bet_pos_weights, bet_norms, bet_adjs, bet_adjs_sizes, \
